    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArtTags", x => new { x.ArtId, x.TagId });
                    table.ForeignKey(
                        name: "FK_ArtTags_Arts_ArtId",
                        column: x => x.ArtId,
                        principalTable: "Arts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ArtTags_Tags_TagId",
                        column: x => x.TagId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArtId = table.Column<Guid>(type: "TEXT", nullable: false),
                    WallLocation = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExhibitionArts", x => new { x.ExhibitionId, x.ArtId });
                    table.ForeignKey(
                        name: "FK_ExhibitionArts_Arts_ArtId",
                        column: x => x.ArtId,
                        principalTable: "Arts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExhibitionArts_Exhibitions_ExhibitionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExhibitionArts_ArtId",
                table: "ExhibitionArts",
                column: "ArtId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_ArtId",
                table: "OrderItems",
                column: "ArtId");
